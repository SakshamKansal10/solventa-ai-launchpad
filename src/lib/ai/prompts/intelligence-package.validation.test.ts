...
function buildOpportunity(opportunityIndex: number, overrides: Record<string, unknown> = {}) {
  return {
    ...
    problemHeadline: "No time to do it themselves",
    solutionHeadline: "Reliable done-for-you service",
    customerHeadline: "Local small business owners",
    moneyHeadline: "Flat monthly fee per client",
