    ...
    <section className="mx-auto max-w-[1180px] px-[18px] py-16 sm:px-6 lg:px-10">
      ...
      <div className="mt-10 flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
        ...
        >
          ...
          <p className="mt-4 text-[0.9rem] font-semibold text-sol-ink">Saksham Kansal</p>
          <p className="mt-1 text-[0.8rem] text-sol-secondary">Founder, Solventia</p>
        </motion.div>
        ...
        <motion.p
          ...
          className="max-w-[56ch] text-[0.98rem] leading-[1.9] text-sol-secondary"
        >
          Most business advice assumes you already have money, connections, or experience. Solventia
          started from a simpler premise: someone with real curiosity and no starting capital
