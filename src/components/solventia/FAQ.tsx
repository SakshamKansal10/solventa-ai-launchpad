...
export function FAQ() {
  return (
    <section id="faq" className="scroll-mt-[84px] bg-sol-surface px-[18px] pb-16 pt-[96px] sm:px-6">
      <div className="mx-auto max-w-[840px]">
        <h2 className="text-center font-display text-[32px] font-semibold leading-[1.15] text-sol-ink sm:text-[36px]">
          Questions before you start?
        </h2>

        <div className="mt-10 rounded-[24px] border border-sol-border bg-sol-page/40 px-6 lg:px-10">
